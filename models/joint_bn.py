...
def main(args):
    ...
    langs = ['bn', 'en', 'hi', 'mag', 'ml', 'mr', 'or', 'pa', 'te', 'ur']
    ...
    special_tokens_dict = {'additional_special_tokens': ['<bn>', '<en>', '<hi>', '<mag>', '<ml>', '<mr>', '<or>', '<pa>', '<te>', '<ur>']}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default='../output/bn/', help='output directory for saving results')
